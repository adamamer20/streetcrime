...
#Standard (Cpython)
roads: --- 132.38868069648743 seconds ---
neighborhoods: --- 661.7026660442352 seconds ---
buildings: --- 1079.5165038108826 seconds ---

#Cythonized but normal implementation
roads: --- 137.25796008110046 seconds ---
neighborhoods: --- 659.7807533740997 seconds ---
e:\Users\adiad\OneDrive - Università Commerciale Luigi Bocconi\Documenti\Università\Third Year\Thesis\thesis\scripts\data_processing_raw\main.py:9: UserWarning: Column names longer than 10 characters will be truncated when saved to ESRI Shapefile.
  data_processing(directory)
buildings: --- 1089.2925071716309 seconds ---
...
data_file_path = os.path.join(module_dir, "data/raw/quartieri.geojson")
