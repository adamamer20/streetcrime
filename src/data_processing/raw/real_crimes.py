...
def process_data():
    ...
    crimes_caldarini = crimes_caldarini[crimes_caldarini.geometry.type == 'Point']
...
def plot_crimes(crimes, info_neighborhoods, name):
    ...
    info_neighborhoods['coords'] = info_neighborhoods['geometry'].centroid.get_coordinates().apply(lambda x: (x['x'], x['y']), axis = 1)
...
def crimes_processing(filename : str,
    ...
    plot_crimes(crimes, info_neighborhoods, name = filename)
...
#info_neighborhoods_caldarini = gpd.read_file('data/processed/info_neighborhoods_caldarini.gpkg')
#info_neighborhoods_minecrime_all = gpd.read_file('data/processed/info_neighborhoods_minecrime_all.gpkg')
crimes_processing('caldarini', crimes_caldarini, neighborhoods)
...
crimes_processing('minecrime_all', crimes_minecrime, neighborhoods)
